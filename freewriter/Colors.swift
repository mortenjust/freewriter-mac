...
struct Colors {
    ...
    // white on dark blue
//    let mainTextColor = NSColor.whiteColor()
//    let editorBackground = NSColor(deviceHue:0.609, saturation:0.812, brightness:0.251, alpha:1)
//    let textForeground = NSColor(calibratedRed:0.608, green:0.646, blue:0.696, alpha:1)
//    let insertionPoint = NSColor(deviceRed:1, green:0.933, blue:0.820, alpha:1)
